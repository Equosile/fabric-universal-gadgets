...
public class OFAAFO_DiceEvent {
    ...
    public static void registerDiceEvent() {
        OFAAFO_ItemTossCallback.ItemTossCallback.EVENT.register((world, player, hand, item) -> {
            //When a dice is tossed from a player hand...
            //Hooked by Custom Event Handler ---> OFAAFO_ItemTossCallBack

            dice_Event_Main(world, player, hand, item);
    ...
    public static void dice_Event_Main(World world, PlayerEntity player, Hand hand, ItemEntity item) {
            ...
            if (hand == Hand.MAIN_HAND) {
                ...
                if (item != null) {
                    ...
                    if (isDice(stackOnEvent)) {
                        ...
                        OFAAFO_TickEvent.addWatcherEvent(Arrays.asList(world, player, item, yInit));
